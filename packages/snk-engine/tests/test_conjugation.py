...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("anke", "future", "anke n'yi ri-ni daga"),
        ("ake", "future", "ake n'yi ri-ni daga"),
        ("oku", "future", "oku yi ri-ni daga"),
        ("xaku", "future", "xaku n'yi ri-ni daga"),
        ("nke", "past_negative", "nke maxa daga"),
        ("anke", "past_negative", "anke maxa daga"),
        ("nke", "future_negative", "nke n'ti ri-ni daga"),
        ("anke", "future_negative", "anke n'ti ri-ni daga"),
        ("anke", "future_negative_ntaxa", "anke n'taxa ri-ni daga"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("rier", "oku", "future", "oku yi ri-ni"),
        ("rier", "ake", "future", "ake n'yi ri-ni"),
        ...
        ("sefeer", "anke", "future_negative", "anke n'ti ri-ni sefe"),
        ("wurier", "anke", "future_negative", "anke n'ti ri-ni wuru"),
        ("sefeer", "ake", "progressive_watia", "ake m'fayi sefe-ne watia"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("sefeer", "iku", "future", "iku n'yi ri-ni sefe"),
        ("rier", "iku", "future", "iku n'yi ri-ni"),
        ("wurier", "nke", "future", "nke yi ri-ni wuru"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("dagaer", "a", "future", "a yi ri-ni daga"),
        ("rier", "an", "past", "an ri"),
        ("sefeer", "i", "future", "i yi ri-ni sefe"),
